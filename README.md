...
I am a versatile software development professional with hands-on experience in developing and deploying low-latency, consistent, decentralized, and highly available microservices and web-based applications using Java ☕️, Angular 2+ 🌐, Postgres 🗄️, GitHub Actions ⚙️, Docker 🐳, Kubernetes 🚀, and AWS ☁️, producing robust systems to meet diverse customer needs.
